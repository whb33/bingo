...
public class DateUtils {
    ...
    public static String getTodateString() {
        String str = yyyyMMdd_NOT_.format(new Date());
        return str;
    }
    ...
    public static String getYesterdayString() {
        Date date = new Date(System.currentTimeMillis() - DATEMM * 1000L);
        String str = yyyyMMdd_NOT_.format(date);
        return str;
    }
    ...
    public static String[] getDate(String beginTime, String endTime, boolean isEndTime) {
        Integer interval = getTwoDayInterval(endTime, beginTime, isEndTime);
        ...
        return result.toArray(new String[interval]);
    }
